 ...
 */
 @Autonomous
public class RobotAutoBlue1 extends RobotTelemetry
...
//end of vuforia class.
    ...
    private void autoRightColumn() {
      ...
      while(!isDone) {
        switch (autoState) {
          case BASELINE : driveStraight(-17,.5);
                          autoState = AutoState.TURN;
              break;
          case TURN : rotate(54,.5);
    ...
    private void autoCenterColumn() {
      ...
      while(!isDone) {
        switch (autoState) {
          case BASELINE : driveStraight(-25,.5);
                          autoState = AutoState.TURN;
              break;
          case TURN : rotate(60,.6);driveStraight(-5,.5);rotate(50,.6);
                      autoState = AutoState.APPROACH;
              break;
          case APPROACH :wantedState = wantedState.SINGLE;
                      while(mSystemState != SystemState.GLYPHS_HIGH){}//wait for elevator to reach target.
          ...
          case HOME : driveStraight(3,.7);
                      ...
                      autoState = AutoState.BACK;
              break;    
          case BACK : driveStraight(-5,.8);//driveStraight(3,.7);rotate(-30,.5);
                      autoState = AutoState.POSITION;
              break;
          case POSITION :driveStraight(18,1.0);SimpleGyroTurn(-150,1.0);
                  autoState = AutoState.END;
              break;
          case END : isDone=true;
              break;
    ...
    private void autoLeftColumn() {
      ...
      while(!isDone) {
        switch (autoState) {
                case BASELINE : driveStraight(-20,.5);
                          autoState = AutoState.TURN;
              break;
          case TURN : rotate(60,.7);driveStraight(-4,.5);rotate(55,.7);
                      autoState = AutoState.APPROACH;
              break;
          case APPROACH : 
          ...
          case HOME : 
                      ...
                      autoState = AutoState.BACK;
              break;    
          case BACK : driveStraight(-5,.5); driveStraight(3,.5);
                      SimpleGyroTurn(-30,1.0);
                      autoState = AutoState.POSITION;
              break;
          case POSITION : 
                  driveStraight(15,.5);
                  SimpleGyroTurn(170,1.0);
                  autoState = AutoState.END;
              break;
          case END : isDone=true;
              break;
