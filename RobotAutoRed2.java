 ...
 */
 @Autonomous
public class RobotAutoRed2 extends RobotTelemetry
...
//end of vuforia class.
    ...
    private void autoRightColumn() {
      ...
      while(!isDone) {
        switch (autoState) {
              ...
              break;
          case TURN : rotate(60,.7);driveStraight(10,.5);rotate(70,.5);
          ...
          case HOME : driveStraight(3,.5);
              ...
              break;    
          case BACK : driveStraight(-5,.5);
                      autoState = AutoState.POSITION;
              break;
          case POSITION :driveStraight(18,.5);SimpleGyroTurn(-180,1.0);
    ...
    private void autoCenterColumn() {
      ...
      while(!isDone) {
        switch (autoState) {
                case BASELINE : driveStraight(16,.5);
                          autoState = AutoState.TURN;
              break;
          case TURN : rotate(60,.7);driveStraight(16,.5);rotate(50,.5);rotate(40,.5);
                      autoState = AutoState.APPROACH;
              break;
          case APPROACH : 
      ...
      while(!isDone) {
        switch (autoState) {
                case BASELINE : driveStraight(16,.5);
                          autoState = AutoState.TURN;
              break;
          case TURN : rotate(50,.7);driveStraight(14,.5);SimpleGyroTurn(135,1.0);
                      autoState = AutoState.APPROACH;
              break;
          case APPROACH : 
                      wantedState = wantedState.SINGLE;
          ...
          case HOME : driveStraight(3,.5);
                      ...
                      autoState = AutoState.BACK;
              break;    
          case BACK : driveStraight(-5,.5);driveStraight(9,.5);
                      autoState = AutoState.POSITION;          
              break;
          case POSITION :SimpleGyroTurn(-90,1.0);
                        driveStraight(-12,.5);SimpleGyroTurn(-30,1.0);
                  autoState = AutoState.END;
              break;
          case END : isDone=true;
              break;
