 ...
 */
 @Autonomous
public class RobotAutoBlue2 extends RobotTelemetry
...
//end of vuforia class.
    ...
    private void autoRightColumn() {
      ...
      while(!isDone) {
        switch (autoState) {
          case BASELINE : driveStraight(-17,.5);SimpleGyroTurn(-80,1.0);
                          autoState = AutoState.TURN;
              break;
          case TURN : driveStraight(-8,.5);rotate(50,.5);
          ...
          case HOME : driveStraight(3,.5);
              ...
              break;    
          case BACK : driveStraight(-6,.5);
                      autoState = AutoState.POSITION;
              break;
          case POSITION :
                  driveStraight(13,.5);SimpleGyroTurn(-55,1.0);
                  driveStraight(-22,.5);SimpleGyroTurn(-35,1.0);
    ...
    private void autoCenterColumn() {
      ...
      while(!isDone) {
        switch (autoState) {
          case BASELINE : driveStraight(-15,.5);
                          autoState = AutoState.TURN;
              break;
          case TURN : rotate(-38,.6);driveStraight(-4,.5);//rotate(-20,.6);
                      autoState = AutoState.APPROACH;
              break;
          case APPROACH :wantedState = wantedState.SINGLE;
                      while(mSystemState != SystemState.GLYPHS_HIGH){}//wait for elevator to reach target.
          ...
          case LOWER : wantedState = wantedState.RAISE_LOWER;
                     ...
                     driveStraight(-6,.5);
                      autoState = AutoState.RELEASE;
              break;
          case RELEASE :clawOpen();clawOpen();sleep(300);
                      autoState = AutoState.HOME;
              break;
          case HOME : driveStraight(3,.7);
                      wantedState = wantedState.HOME;
                      while(mSystemState != SystemState.HOME){}//wait for elevator to reach target.
                      autoState = AutoState.BACK;
              break;    
          case BACK : driveStraight(-6,.8);//driveStraight(3,.7);rotate(-30,.5);
                      autoState = AutoState.POSITION;
              break;
          case POSITION :
                  driveStraight(13,.5);SimpleGyroTurn(-55,1.0);
                  driveStraight(-24,.5);SimpleGyroTurn(-30,1.0);
                  autoState = AutoState.END;
              break;
          case END : isDone=true;
              break;
    ...
    private void autoLeftColumn() {
      ...
      while(!isDone) {
        switch (autoState) {
                case BASELINE : driveStraight(-18,.5);
                          autoState = AutoState.TURN;
              break;
          case TURN : rotate(-35,.7);//driveStraight(-6,.5);//rotate(35,.7);
                      autoState = AutoState.APPROACH;
              break;
          case APPROACH : 
          ...
          case HOME : 
                      ...
                      autoState = AutoState.BACK;
              break;    
          case BACK : driveStraight(-4,.5); 
                      autoState = AutoState.POSITION;
              break;
          case POSITION : 
                  driveStraight(10,.5);
                  SimpleGyroTurn(-45,1.0);
                  driveStraight(-25,.5);
                  SimpleGyroTurn(-20,1.0);
                  autoState = AutoState.END;
              break;
          case END : isDone=true;
              break;
      ...
      while (!isDone) { // 
        switch (autoState) {
          ...
          case COLOR : detectBlue();
              ...
              break;
          case KNOCK_OFF : blueJewelKnockOff(isBlue);
                        autoState = AutoState.BASELINE;
              break;
    ...
    public void blueJewelKnockOff(boolean blue){
      //if the color sensor sees blue, drives forward. Else drive away.
      jewelArmDown();
      if(blue){
        driveStraight(5,.25);
        sleep(800);
